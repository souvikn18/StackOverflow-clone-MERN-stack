                ...
                <div className='flex gap-4'>
                    {
                        ...
                        <>
                        <Link to='/user'>
                            <Avatar backgroundColor="#009dff" px="10px" py="7px" borderRadius="50%" color="white" height="40px" width="40px" fontSize="18px">{user?.existingUser?.name.charAt(0).toUpperCase()}</Avatar>
                        </Link>
                        <Link to='/'>
